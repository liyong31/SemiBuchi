/* Generated By:JavaCC: Do not edit this line. JBAParser.java */
...
public class JBAParser implements JBAParserConstants {
  ...
  Token stateOrLetterStr, labelStr, sourceStr, targetStr;
    stateOrLetterStr = jj_consume_token(STRING);
    if (jj_2_1(2)) {
      jj_consume_token(COMMA);
      // no initial state so start with transitions
  ...
  Token stateIdStr;
    ...
    while (true) {
      ...
      stateIdStr = jj_consume_token(STRING);
  ...
  public JBAParserTokenManager token_source;
  ...
  public JBAParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public JBAParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new JBAParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public JBAParser(java.io.Reader stream) {
  ...
  public JBAParser(JBAParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(JBAParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;

...
public class IntSetTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("test sparse bits");
		testIterator(sparseBitSets);
		IntSetSparseBits cp = (IntSetSparseBits) sparseBitSets.clone();
		cp.set(7000_000 - 1);
		testEq(sparseBitSets, cp);
		testSubset(sparseBitSets, cp);

...
//		System.out.println(A.toDot());
		assertEquals(false, new BuchiIsEmptyNestedDFS(A, 10000).getResult());
	} 
...
//		System.out.println(B.toDot());
		assertEquals(false, new BuchiIsEmptyNestedDFS(B, 10000).getResult());
	} 
...
//		System.out.println(C.toDot());
		assertEquals(false, new BuchiIsEmptyNestedDFS(C, 10000).getResult());
	} 
...
//		System.out.println(D.toDot());
		assertEquals(false, new BuchiIsEmptyNestedDFS(D, 10000).getResult());
	} 
...
//		System.out.println(E.toDot());
		assertEquals(true, new BuchiIsEmptyNestedDFS(E, 10000).getResult());
	} 

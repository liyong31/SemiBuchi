...
//		System.out.println(A.toDot());
		assertEquals(false, new BuchiIsEmptyTarjanOriginal(A, 10000).getResult());
	} 
...
//		System.out.println(B.toDot());
		assertEquals(false, new BuchiIsEmptyTarjanOriginal(B, 10000).getResult());
	} 
...
//		System.out.println(C.toDot());
		assertEquals(false, new BuchiIsEmptyTarjanOriginal(C, 10000).getResult());
	} 
...
//		System.out.println(D.toDot());
		assertEquals(false, new BuchiIsEmptyTarjanOriginal(D, 10000).getResult());
	} 
...
//		System.out.println(E.toDot());
		assertEquals(true, new BuchiIsEmptyTarjanOriginal(E, 10000).getResult());
	} 
